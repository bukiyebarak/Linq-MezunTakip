<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Kayit.aspx.cs" Inherits="MezunTakip.Kayit" %>
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                <div class="col-wrap">
                                                    <div class="ico-box bg-gray-light has-radius-medium">
                                                        ...
                                                        <h5 class="text-center">(pdf dosya formatı, max 30 MB)</h5>
                                                        <div class="row">
                                                            <div class="col-md-8">
                                                                <div class="form-group">
                                                                    <label id="txtCVOkulNo" runat="server" type="text" placeholder="Öğrenci Numaranız" class="form-control" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                ...
                                                <div class="col-wrap">
                                                    <div class="ico-box bg-gray-light has-radius-medium">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label class="label-text font-weight-bold ">ÖĞRENCİ NUMARANIZ:</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-8">
                                                                <div class="form-group">
                                                                    <input id="txtTavsiyeOgrenciNo" runat="server" type="text" placeholder="Öğrenci Numaranız" class="form-control" required />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <div class="modal-footer justify-content-start bg-gray-light">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <a href="Kayit.aspx">&nbsp &nbsp &nbsp KAYIT OL</a>
                                    </div>
                                    <p>
